        ...
        public void transformPage(View page, float position) {
            ...
            if(position <= -1.0f || position >= 1.0f) {
                ...
                if (welcomeImage01 != null) {
                    ViewHelper.setTranslationX(welcomeImage01, pageWidth/2 * position);
                    ViewHelper.setAlpha(welcomeImage01,1.0f - Math.abs(position));
                }

                if (welcomeImage02 != null) {
                    ViewHelper.setTranslationX(welcomeImage02, pageWidth/2 * position);
                    ViewHelper.setAlpha(welcomeImage02,1.0f - Math.abs(position));
                }

                if (welcomeImage03 != null) {
                    ViewHelper.setTranslationX(welcomeImage03, pageWidth/2 * position);
